...
public class WaveView extends View {
    ...
    //是指波纹的   上面  起伏幅度
    private static final int SWINGONE = 10;
    //是指波纹的   底部 起伏幅度
    private static final int SWINGTWO = 10;
    ...
    //设置 波纹的 流动速度     为 底部 的波纹 view
    private static final int STEP2 = 18;
...
//        mPaint1.setAlpha(250);

        mPaint2 = new Paint(Paint.ANTI_ALIAS_FLAG);
        mPaint2.setColor(Color.parseColor("#ffffff"));

        mPaint2.setColor(Color.parseColor("#AB9DCF"));
